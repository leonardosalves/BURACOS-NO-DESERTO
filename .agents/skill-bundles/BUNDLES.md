...
> 🔗 [[MEMORIA-LUMIERA]] · [[skills/studio-agents-hermes]] · [[SKILLS]]
...
- `publish-seo.json` — ver [[skills/studio-agents-hermes]]
- `shorts-ideas.json` — ver [[skills/studio-agents-hermes]]
...
- `visual-prompt.json` — ver [[skills/studio-agents-hermes]]
