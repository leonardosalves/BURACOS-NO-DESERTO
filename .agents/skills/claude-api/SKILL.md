> 🔗 [[MEMORIA-LUMIERA]] · [[skills/claude-api|claude api]] · [[SKILLS]]

---
name: claude-api
description: |
  Referência Claude API / Anthropic SDK — modelos, pricing, tool use, MCP, agents.
  Triggers: Claude, Anthropic, Opus, Sonnet, Haiku, anthropic SDK, API Claude.
  SKIP quando o projeto usa Gemini/OpenAI (Lumiera default: Gemini em dashboard-qanat).
metadata:
  lumiera: true
...
Ver [[memory/agent-frameworks-reference]] para padrões multi-agente (OpenAI Agents, Google ADK).
