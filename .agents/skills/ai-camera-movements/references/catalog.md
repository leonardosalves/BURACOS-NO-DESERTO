...
**Uso:** copiar o bloco `prompt` e trocar o sujeito genérico pelo da cena Lumiera.

IDs estáveis: `acm-{shot}` (ex.: `acm-08`, `acm-15b`).
...
### acm-17 — Follow shot / over-the-shoulder
...
### acm-18 — Reverse tracking / walk-and-talk
...
### acm-15b — Orbit counterclockwise
...
## Índice por nome (busca rápida)

| Nome                          | ID               |
| ----------------------------- | ---------------- |
| Static shot                   | acm-01           |
| Pan right / left              | acm-02 / 02b     |
| Whip pan right / left         | acm-03 / 03b     |
| Tilt up / down                | acm-04 / 04b     |
| Slow zoom in / out            | acm-05 / 05b     |
| Fast zoom in / out            | acm-06 / 06b     |
| Crash zoom in / out           | acm-07a / 07b    |
| Dolly in / out                | acm-08 / 09      |
| Truck right / left            | acm-10 / 10b     |
| Pedestal up / down            | acm-11a / 11b    |
| Slider right / left           | acm-12 / 12b     |
| Push past                     | acm-13           |
| Arc right / left              | acm-14 / 14b     |
| Orbit CW / CCW                | acm-15 / 15b     |
| Tracking                      | acm-16           |
| Follow / OTS                  | acm-17           |
| Reverse tracking              | acm-18           |
| Side / Low / Vehicle tracking | acm-19 / 20 / 21 |
| Chase                         | acm-22           |
| Handheld                      | acm-23           |
| Snorricam                     | acm-24           |
| Crane up / down               | acm-25 / 25b     |
| Drone push / pull             | acm-26 / 26b     |
| Helicopter                    | acm-27           |
| FPV                           | acm-s1           |
| Tilt-shift                    | acm-s2           |
| Infinite zoom                 | acm-s3           |
| Earth zoom out                | acm-s4           |
| Time-lapse                    | acm-s5           |
| Pass-through                  | acm-s6           |
