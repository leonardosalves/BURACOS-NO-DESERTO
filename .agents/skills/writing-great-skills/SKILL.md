...
description: |
  Reference for writing and editing skills well — vocabulary and principles for predictable skills.
  Triggers Lumiera: criar skill, editar SKILL.md, autoria .agents/skills.
...
- Skills vivem em `.agents/skills/<nome>/SKILL.md`
- Adicionar `metadata.lumiera: true`, `tasks`, `formats` quando relevante
