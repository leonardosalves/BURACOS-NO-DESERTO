...
1. **주제 (Subject)**
   ...
   - 예: _도시 경관_, _자연_, _차량_, _강아지_

2. **동작 (Action)**
   - 피사체가 하는 행동
   - 예: _걷기_, _달리기_, _머리 돌리기_

3. **스타일 (Style)**
   - 특정 영화 스타일 키워드
   - 예: _SF_, _공포 영화_, _필름 누아르_, _만화_

#### 선택 요소

4. **카메라 위치 및 모션**
   - _공중 촬영_, _눈높이_, _위에서 아래로 촬영_
   - _돌리 샷_, _로우 앵글_, _POV 샷_

5. **구도 (Composition)**
   - _와이드 샷_, _클로즈업_, _싱글 샷_, _투 샷_

6. **포커스 및 렌즈 효과**
   - _얕은 포커스_, _깊은 포커스_, _소프트 포커스_
   - _매크로 렌즈_, _광각 렌즈_

7. **분위기 (Mood)**
   - _파란색 톤_, _야간_, _따뜻한 색조_
