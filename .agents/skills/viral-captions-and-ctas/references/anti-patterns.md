...
The shape Meta and TikTok policy explicitly demote. Named by Meta since
2017, with enforcement tightened: hundreds of thousands of accounts
have been actioned for spammy or fake-engagement behaviour in recent
enforcement waves.
...
- "Comment [emoji] for the link"

The test: are you asking for the **content** of the engagement (a real
opinion, a specific story, a recommendation) or just the **act** of
engaging? The act is bait. The content is allowed.

Rewrites that keep the intent:

- "Like for part 2" → "I'm filming the part nobody talks about. It'll
  go up tomorrow."
- "Comment YES for the routine" → "Full routine is in the pinned
  comment."
...
> Best skincare tips for skincare routine. My skincare routine for
> sensitive skin skincare. Skincare for beginners and skincare for
> dry skin.

Clean:

> The reason your retinol is peeling has nothing to do with the
> retinol. I switched two products and the flaking stopped in four
> days.

One primary keyword, once, early. One or two secondary terms used
naturally. That's the whole rule.
...
## Repeating the hook verbatim in the caption

The caption is a second surface. It should add context, payoff, or a
complementary angle, not echo the on-screen text word-for-word.

If the video already shows "I tried this for 30 days and it changed
my skin", the caption should be one of:

- "Here's exactly what changed."
- "The two products I added (and the one I cut)."
- "Day 14 is when I noticed it."

Not "I tried this for 30 days and it changed my skin." That dilutes
both surfaces and wastes the SEO slot.
...
Caption promises a "free guide", the auto-DM sends a $297 course sales
page. Triggers spam reports, kills trust, and repeated bait-and-switch
flows are part of what gets accounts demoted under spammy-behaviour
enforcement.

The rule: whatever the caption promises, the DM delivers, first,
before any pitch.
...
"This is for everyone" / "whether you're a beginner or a pro". Cuts
the targeting that makes the right viewer feel "this is for me". Pick
a person and write to them.

## Closing on a question that doesn't earn an answer

"What do you think?" with nothing to react to. The viewer has to
manufacture an opinion to comment, which they won't. Either pose a
real binary or a real stance, or skip the question.
