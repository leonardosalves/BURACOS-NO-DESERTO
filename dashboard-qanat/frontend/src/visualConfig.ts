...
export function pickVisualConfigFromDisk(
  config: VisualConfig = {}
): VisualConfig {
...
export function pickVisualConfig(config: VisualConfig = {}): VisualConfig {
  ...
  if (
    !out.caption_mode_short &&
    !out.caption_style_short &&
    !out.caption_effect_short
  ) {
    if (legacy === "shorts-viral") out.caption_mode_short = "caption-highlight";
    else if (legacy === "documentary")
      out.caption_mode_short = "caption-pill-karaoke";
  }
  if (
    !out.caption_mode_long &&
    !out.caption_style_long &&
    !out.caption_effect_long
  ) {
    if (legacy === "documentary")
      out.caption_mode_long = "caption-pill-karaoke";
    else if (legacy === "shorts-viral")
      out.caption_mode_long = "caption-highlight";
  }
  return out;
}
...
export function visualDraftToApiPatch(
  draft: VisualConfig,
