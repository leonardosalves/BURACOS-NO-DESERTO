...
export const LazyOverlayTimelineEditor = lazy(() =>
  import("./OverlayTimelineEditor").then((m) => ({ default: m.OverlayTimelineEditor })),
);

export const LazyYoutubeStudioPanel = lazy(() =>
  import("./YoutubeStudioPanel").then((m) => ({ default: m.YoutubeStudioPanel })),
);

export const LazyVideoResurrectorPanel = lazy(() =>
  import("./VideoResurrectorPanel").then((m) => ({ default: m.VideoResurrectorPanel })),
);
...
export const LazyTrendForecastPanel = lazy(() =>
  import("./TrendForecastPanel").then((m) => ({ default: m.TrendForecastPanel })),
);
...
export const LazyProjectsLibraryPanel = lazy(() =>
  import("./ProjectsLibraryPanel").then((m) => ({ default: m.ProjectsLibraryPanel })),
);
...
export const LazyNarrationReviewPanel = lazy(() =>
  import("./NarrationReviewPanel").then((m) => ({ default: m.NarrationReviewPanel })),
);

export const LazyNarrationChunksPanel = lazy(() =>
  import("./NarrationChunksPanel").then((m) => ({ default: m.NarrationChunksPanel })),
);

export const LazyTtsVoiceStudioPanel = lazy(() =>
  import("./TtsVoiceStudioPanel").then((m) => ({ default: m.TtsVoiceStudioPanel })),
);
...
export const LazyNarrationReplacePanel = lazy(() =>
  import("./NarrationReplacePanel").then((m) => ({ default: m.NarrationReplacePanel })),
);
...
export function TabPanelFallback({ label = "Carregando..." }: { label?: string }) {
  return (
