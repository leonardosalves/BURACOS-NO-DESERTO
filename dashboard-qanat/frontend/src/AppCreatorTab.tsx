...
export type AppCreatorTabProps = {
  ...
  handleUpdateCreatorScene: (index: number, field: string, value: any) => void;
...
export function AppCreatorTab({
  ...
  const [scenePanelTab, setScenePanelTab] = useState<
    Record<string, "prompt" | "asset">
  >({});
  ...
  const generateExpressShort = async () => {
    ...
    if (!/[a-zA-Z0-9]/.test(safeProjectName)) {
      toast.error(
        "O nome do projeto deve conter pelo menos uma letra ou número."
      );
      return;
    }
    ...
    <>
              ...
              <div className="mx-auto max-w-5xl space-y-4 font-sans">
                ...
                <section className="space-y-4 rounded-[24px] border border-white/[0.07] bg-[#0b0c0f] p-4 sm:p-5">
                      ...
                      {useNotebooklm && (
                        <label className="mt-3 flex cursor-pointer items-center gap-2.5 select-none">
                          <input
                            ...
                            onChange={(e) =>
                              setNotebooklmDeep(e.target.checked)
                            }
                            className="w-4 h-4 rounded border-zinc-700 bg-zinc-900 text-gold-500 focus:ring-gold-500/30"
                          />
                      ...
                      <div className="flex flex-wrap gap-2 pt-1">
                        {editorialIdeaImport.approvedNarration ? (
                          <span className="inline-flex items-center gap-2 rounded-xl border border-emerald-400/30 bg-emerald-400/10 px-4 py-2.5 text-xs font-bold text-emerald-300">
                            <CheckCircle className="h-4 w-4" /> Narracao
                            importada intacta · revise e aprove abaixo
                          </span>
                        ) : (
                          <button
                            type="button"
                  ...
                  <p className="border-t border-white/[0.06] pt-3 text-[9px] leading-4 text-zinc-600">
                    Entrada exclusiva do menu lateral · a narração aprovada
                    segue para voz, cenas, edição e publicação sem trocar de
                    módulo.
                  </p>
                </section>
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4 border-b border-cyan-300/10 pb-5">
                      <div>
                        <p className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[0.2em] text-cyan-300">
                          <Fingerprint className="h-4 w-4" /> Storyboard
                          importado
                        </p>
                  ...
                  <div className="relative mx-auto max-w-4xl overflow-hidden rounded-[28px] border border-rose-300/20 bg-[#12070a] shadow-2xl shadow-black/30">
                    ...
                    <div className="relative space-y-6 px-6 py-6 sm:px-8">
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-[9px] text-zinc-600">
                          Descreva o tema específico. Quanto mais concreto,
                          melhor o gancho gerado.
                        </p>
                      </div>
                      ...
                      <div className="flex flex-col items-center gap-3 border-t border-rose-300/10 pt-6 sm:flex-row sm:justify-between">
                        <p className="text-[9px] text-zinc-600">
                          O roteiro será gerado com gancho, desenvolvimento e
                          fechamento automáticos.
                        </p>
                        <button
                          type="button"
                  ...
                  <div className="mx-auto max-w-4xl space-y-6 rounded-[28px] border border-cyan-300/20 bg-[#071115] p-5 shadow-2xl shadow-black/20 sm:p-7">
                    <div className="grid gap-5 border-b border-cyan-300/10 pb-5 md:grid-cols-[1fr_auto] md:items-end">
                      <div>
                        ...
                        <p className="mt-2 max-w-2xl text-[11px] leading-5 text-zinc-400">
                          Registre a ideia como você pensou. O diagnóstico
                          separa realidade, oportunidade e retenção antes de
                          tocar no seu texto.
                        </p>
                      </div>
                      ...
                      {customIdeaOpportunity && (
                        <div className="space-y-3 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-4 text-[10px]">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <span className="rounded bg-zinc-900 px-2 py-1 text-zinc-300">
                              Saturação:{" "}
                              {customIdeaOpportunity.saturation_level}
                            </span>
                            <span className="rounded bg-zinc-900 px-2 py-1 text-zinc-300">
                      ...
                      <div className="bg-zinc-950/60 border border-zinc-900 p-5 rounded-2xl space-y-4 mt-6 text-left">
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setCustomIdeaPromise(e.target.value)
                            }
                            className="w-full bg-zinc-900 border border-zinc-800 focus:border-gold-500 focus:outline-none rounded-xl px-3 py-2.5 text-xs text-white placeholder:text-zinc-600 font-semibold"
                        ...
                        <div className="space-y-2">
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setCustomIdeaBlocks(e.target.value)
                            }
                    ...
                    <div className="bg-zinc-950/40 border border-zinc-900/60 p-5 rounded-2xl space-y-2 mt-4 font-sans">
                      ...
                      <span className="text-[9px] text-zinc-500 block leading-normal mt-1">
                        * O assistente criará automaticamente uma pasta separada
                        no workspace com todas as mídias e scripts dedicados
                        para este projeto.
                      </span>
                    </div>
                  ...
                  <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                    {config?.narration_mode === "chunked" ? (
                      ...
                      <>
                        ...
                        — substituindo as durações estimadas do roteiro. Isso
                        gera `word_transcripts.json`, `block_timings.json` e os
                        slots da timeline.
                      </>
                    )}
                  </p>
                ...
                <div className="grid grid-cols-1 gap-3 pt-2 font-sans sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  <div className="flex min-h-48 flex-col justify-between rounded-2xl border border-zinc-800 bg-[#0b0c0f] p-5 transition hover:border-zinc-700">
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 mt-2 leading-relaxed">
                        Compila o vídeo final padrão usando as mídias da linha
                        do tempo e legendas animadas.
                      </p>
                    </div>
                ...
                <section className="rounded-3xl border border-cyan-300/20 bg-[#071115] p-5 shadow-xl shadow-black/20">
                  ...
                  {youtubeMetadataParsed?.titles?.length ? (
                    ...
                    <p className="mt-4 rounded-xl border border-dashed border-zinc-800 px-4 py-3 text-[10px] text-zinc-600">
                      O pacote sera gerado automaticamente no render ou pelo
                      botao acima.
                    </p>
                  )}
              ...
              <div className="space-y-6 max-w-2xl mx-auto py-6 font-sans">
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 mt-1">
                    Gerados automaticamente ao renderizar no passo 5 — ou
                    regenere com IA abaixo.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4 space-y-3">
                  ...
                  {youtubeMetadataParsed?.titles?.length ? (
                    ...
                    !youtubeMetadata.startsWith("[Erro]") ? (
            ...
            {creatorStep > 1 &&
              ...
              (String(generatedScriptData.strategy?.title_main || "").trim() ||
                ...
                <div className="glass-panel p-6 rounded-3xl mt-8 space-y-6 font-sans">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-gray-300">
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-[9px] text-zinc-500 mt-0.5">
                          Ancorado no roteiro — específico, sem clickbait
                          genérico
                        </p>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      {Array.isArray(
                        ...
                        generatedScriptData.checklist.corrections.length >
                          0 && (
                          <div>
                            <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider block">
                              Correções
                  ...
                  <CreatorProductionPlanPanel
                    storyboard={generatedScriptData}
                  />
                        ...
                        <div className="space-y-4 font-sans">
                          {(() => {
                            ...
                            if (!isReverseEngineeredStoryboard) {
                              const maxPromptBlock = Math.max(
                                0,
                                ...Object.keys(promptsByBlock).map(Number)
                              );
                            ...
                            let sortedBlocks = Object.keys(promptsByBlock)
                              .map(Number)
                              .filter((blockNum) => {
                                if ((promptsByBlock[blockNum]?.length || 0) > 0)
                                  return true;
                                if (
                                  blockPhrases.length > 0 &&
                                  blockNum <= blockPhrases.length
                                )
                                  return true;
                                return false;
                              })
                                                  ...
                                                  <div className="space-y-3">
                                                    ...
                                                    {currentAsset?.asset ? (
                                                      <div className="rounded-xl border border-zinc-850 bg-zinc-950/80 p-2.5 space-y-2">
                                                        ...
                                                        <div className="flex items-center justify-between">
                                                          <span
                                                            className="text-[10px] text-white font-semibold truncate max-w-[200px]"
                                                            title={
                                                              currentAsset.asset
                                                            }
                                                          >
                                                    ...
                                                    <div className="rounded-xl border border-cyan-500/15 bg-cyan-500/[0.035] p-2.5 space-y-2">
                                                            ...
                                                            onClick={async () => {
                                                              try {
                                                                toast.loading(
                                                                  "Gerando vídeo IA...",
                                                                  {
                                                                    id: `gen-${absoluteIndex}`,
                                                                  }
                                                                );
                                                                const res =
                                                                  await fetch(
                                                                    "/api/mobilewan/generate",
                                                                    {
                                                                      method:
                                                                        "POST",
                                                                      headers: {
                                                      ...
                                                      <div className="flex flex-wrap items-center gap-1.5 pt-1 border-t border-zinc-850/50">
                                                        ...
                                                        <a
                                                          ...
                                                          className="text-[8px] text-zinc-500 hover:text-emerald-300 transition"
                                                        >
                                                          Pexels
                                                        </a>
                                                        <a
                                                        ...
                                                        <a
                                                          ...
                                                          target="_blank"
                                                          rel="noopener noreferrer"
                                                          className="text-[8px] text-zinc-500 hover:text-sky-300 transition"
                                                        >
                                                          Bing
                                                        </a>
                                                        <a
                                                          ...
                                                          onClick={() => {
                                                            ...
                                                            toast.success(
                                                              `Briefing ${stockSearch.aspectRatio} copiado.`
                                                            );
                                                          }}
                    ...
                    <div className="border-t border-zinc-900 pt-4 space-y-4">
                      <div className="flex items-center justify-between gap-4">
                        <div>
                          ...
                          <p className="text-[10px] text-zinc-500 mt-1">
                            Tags por frase com pausas em viradas, numeros e
                            gancho — usa a narracao taggeada do roteiro quando
                            disponivel.
                          </p>
                        </div>
                        <button
      ...
      <StockSearchModal
        ...
        onSelect={(item: StockItem) => {
          ...
          const filename = item.downloadUrl?.startsWith("http")
            ? item.previewUrl
            : item.downloadUrl;
