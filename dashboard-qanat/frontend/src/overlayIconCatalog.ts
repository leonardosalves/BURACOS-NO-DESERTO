...
export const LOTTIE_ICON_CATALOG: OverlayIconDef[] = [
  ...
  { id: 'building', label: 'Edifício', category: 'Geografia', lottieFile: 'globe.json' },
  { id: 'gear', label: 'Engrenagem', category: 'Tech', lottieFile: 'lottie_ui_gear_1.json' },
  { id: 'shield', label: 'Escudo', category: 'Geral', lottieFile: 'lottie_ui_lock_3.json' },
  { id: 'crown', label: 'Coroa', category: 'Negócios', lottieFile: 'lottie_biz_crown_1.json' },
  { id: 'science', label: 'Ciência', category: 'Tech', lottieFile: 'lottie_tech_bolt_1.json' },
  { id: 'history', label: 'História', category: 'História', lottieFile: 'lottie_ui_time_1.json' },
  { id: 'nature', label: 'Natureza', category: 'Natureza', lottieFile: 'weather_wind.json' },
  ...
  { id: 'book', label: 'Livro', category: 'História', lottieFile: 'lottie_tech_document_1.json' },
  ...
  { id: 'delivery', label: 'Entrega', category: 'Negócios', lottieFile: 'lottie_biz_delivery_1.json' },
