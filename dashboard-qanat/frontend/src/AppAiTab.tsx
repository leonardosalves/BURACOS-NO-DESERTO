      ...
      <div className="flex flex-col flex-1 min-h-0 space-y-6 overflow-y-auto">
        <div className="dash-status-card">
          <div className="flex items-center gap-3">
            <div
              className={`w-8 h-8 rounded-lg flex items-center justify-center ${hasApiKey ? "bg-emerald-500/10 text-emerald-500" : "bg-dash-primary/10 text-dash-primary"}`}
            >
              {hasApiKey ? (
            ...
            <div>
              <SectionHeader
                ...
                helpId="ai-provider-panel"
                size="sm"
                titleClassName="text-xs tracking-wide"
              />
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-4 lg:gap-6 min-h-0 min-w-0">
            ...
            <div className="flex justify-between items-start dash-chat-panel-header">
              <div>
                <SectionHeader
                  ...
                  subtitle={
                    <>
                      Passo 1:{" "}
                      <strong className="text-zinc-300">Gerar Metadados</strong>{" "}
                      → Passo 2:{" "}
                      <strong className="text-zinc-300">
                        Gerar Thumbnails
                      </strong>{" "}
                      (botão verde). Títulos, descrição, tags e 3 capas A/B para
                      upload no YouTube.
                    </>
                  }
                />
                {(youtubeMetadataFormat ||
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2">
                    {youtubeMetadataFormat && (
                      <span
                        className={`inline-flex text-[9px] font-bold px-2 py-0.5 rounded ${youtubeMetadataFormat === "SHORT" ? "bg-fuchsia-500/10 text-fuchsia-400" : "bg-sky-500/10 text-sky-400"}`}
                      >
              ...
              <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end">
                <button
                  ...
                  title={
                    uploadStatus.canva?.connected
                      ? "Gera capas A/B/C automaticamente via Canva Connect"
                      : "Conecte o Canva em Upload → Integrações"
                  }
                ...
                <button
                  ...
                  title={
                    youtubeMetadataParsed?.thumbnails?.length
                      ? "Gera 3 imagens de capa A/B/C"
                      : "Gere os metadados primeiro (passo 1)"
                  }
                ...
                >
                  ...
                  <span>
                    {youtubeLoading ? "Gerando..." : "Gerar Metadados"}
                  </span>
                </button>
              </div>
            </div>
            ...
            <div className="flex-1 dash-inset-panel mt-3 relative">
              {youtubeLoading ? (
                <div className="flex flex-col items-center justify-center h-full gap-3 text-dash-muted text-xs">
                  ...
                  <span>
                    A IA está analisando o roteiro e gerando metadados ideais...
                  </span>
                </div>
              ) : youtubeMetadata ? (
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center gap-2 flex-wrap">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(youtubeMetadata, "youtube")
                      }
                      ...
                      <div className="flex items-center justify-between gap-2 flex-wrap">
                        <div>
                          <SectionHeader
                            ...
                            helpId="thumbnails-ab"
                            size="sm"
                            titleClassName="text-gold-500 tracking-wide uppercase text-xs"
                          />
                          <span className="text-[9px] text-zinc-500">
                            {uploadStatus.canva?.connected
                              ? "Canva automático ou local sharp"
                              : "Conecte o Canva para gerar capas sem abrir o navegador"}
                          </span>
                        </div>
                        ...
                        {(youtubeMetadataParsed.thumbnails?.length
                          ...
                          : (youtubeMetadataParsed.titles || [])
                              ...
                              .map((t, i) => ({
                                ...
                                label:
                                  ["Curiosidade", "Contraste", "Prova Visual"][
                                    i
                                  ] || "Variante",
                                overlayText: t.text
                                  ?.split(" ")
                          ...
                          return (
                            <div
                              key={thumb.id}
                              className={`bg-zinc-900/50 border rounded-lg p-3 space-y-2 ${ytThumbnailVariant === thumb.id ? "border-gold-500/60 ring-1 ring-gold-500/20" : "border-zinc-800"}`}
                            >
                              {generated?.url && (
                                <a
                                  href={generated.url}
                                  target="_blank"
                                  rel="noreferrer"
                                  className="block rounded-lg overflow-hidden border border-zinc-800 hover:border-gold-500/40 transition"
                                >
                                  <img
                              ...
                              {thumb.overlayText && (
                                <div className="bg-zinc-950 border border-zinc-800 rounded px-2 py-1.5">
                                  ...
                                  <span className="text-sm font-black text-gold-400 tracking-wide">
                                    {thumb.overlayText}
                                  </span>
                                </div>
                              )}
                              ...
                              <div className="grid grid-cols-2 gap-1.5">
                                ...
                                {generated?.url ? (
                                  ...
                                  <span className="text-[9px] text-zinc-600 text-center py-1.5">
                                    Gere imagens
                                  </span>
                                )}
                              </div>
                  ...
                  {(() => {
                    const sections = normalizeYoutubeMetadataDisplay(
                      youtubeMetadata
                    )
                      .split(/^## /m)
                      .filter(Boolean)
                    ...
                    return sections.map((section, sIdx) => {
                      ...
                      return (
                        <div
                          key={sIdx}
                          className="bg-zinc-950 border border-zinc-900 rounded-xl p-4 relative group"
                        >
                            ...
                            youtubeMetadataParsed?.titles?.length ? (
                              <div className="space-y-3 not-prose">
                                <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-3 space-y-2">
                                  <div className="flex items-center justify-between gap-2 flex-wrap">
                                    <div>
                                      ...
                                      <p className="text-[9px] text-zinc-500">
                                        Publique o vídeo, cole o videoId e
                                        alterne títulos com analytics do
                                        YouTube.
                                      </p>
                                    </div>
                                    <button
                                  ...
                                  {titleExperimentAnalytics?.available && (
                                    <div className="space-y-2">
                                      ...
                                      {titleRetention?.velocity?.views48h !=
                                        null && (
                                      ...
                                      <div className="flex gap-2 flex-wrap">
                                        ...
                                        <button
                                          ...
                                          onClick={async () => {
                                            ...
                                            toast(
                                              "Experimento de títulos encerrado."
                                            );
                                            fetchTitleExperiment();
                                          }}
                                ...
                                {youtubeMetadataParsed.titles.map((t, tIdx) => {
                                  ...
                                  const hasEmoji =
                                    /\p{Extended_Pictographic}/u.test(t.text);
                                  const maxChars =
                                    youtubeMetadataFormat === "SHORT"
                                      ? hasHashtag || hasEmoji
                                        ? 55
                                  ...
                                  const isRecommended =
                                    tIdx === 0 ||
                                    t.text ===
                                      youtubeMetadataParsed.recommendedTitle;
                                  const variantId = String.fromCharCode(
                                    65 + tIdx
                                  );
                                  const isAbSelected =
                                    titleAbSelected[String(tIdx)] !== false;
                                  const isActiveVariant =
                                    titleExperiment?.activeVariantId ===
                                    variantId;
                                  ...
                                  return (
                                    <div
                                      key={tIdx}
                                      className={`flex items-start justify-between gap-2 bg-zinc-900/50 border rounded-lg px-3 py-2 ${isRecommended ? "border-gold-500/40 ring-1 ring-gold-500/15" : isActiveVariant ? "border-violet-500/50 ring-1 ring-violet-500/20" : "border-zinc-800"}`}
                                    >
                                      <div className="min-w-0 flex items-start gap-2">
                                        ...
                                        <div>
                                          ...
                                          <span className="text-xs text-zinc-200 break-words whitespace-normal leading-snug">
                                            {t.text}
                                          </span>
                                          <span
                                            className={`ml-2 text-[9px] font-mono ${ok ? "text-emerald-500" : "text-amber-500"}`}
                                          >
                                            {t.chars}/{maxChars}
                                          </span>
                                          ...
                                          {isActiveVariant && (
                                            <span className="ml-2 text-[8px] text-violet-400 font-bold">
                                              ATIVO NO YT
                                            </span>
                                          )}
                                          {typeof ranking?.periodViews ===
                                            "number" && (
                                            <span className="block text-[8px] text-emerald-500 mt-0.5">
                                              {ranking.periodViews} views no
                                              período deste título
                                      ...
                                      <div className="flex flex-col gap-1 shrink-0">
                                        <button
                                          onClick={() => {
                                            ...
                                            toast(
                                              `Título #${tIdx + 1} aplicado na aba Upload.`
                                            );
                                          }}
                ...
                <div className="flex flex-col items-center justify-center h-full text-center p-6 text-gray-500 text-xs gap-2">
                  ...
                  <span>
                    Clique em "Gerar Metadados" para criar títulos magnéticos,
                    descrição otimizada, tags e capítulos com carimbo de
                    data/hora reais baseados no roteiro sincronizado.
                  </span>
                </div>
              )}
            </div>
          ...
          <div className="flex-1 dash-chat-panel font-sans">
            ...
            <DashminAiChat
              ...
              suggestions={[
                {
                  label: "💡 Sugerir Destaques",
                  message:
                    "Sugerir palavras-chave extras para destacar baseadas no roteiro.",
                },
                {
                  label: "🔥 Impactos Épicos",
                  message:
                    "Melhorar frases de impacto para deixá-las mais dramáticas e épicas.",
                },
                {
                  label: "🎵 Análise Musical",
                  message:
                    "Me sugira faixas de trilha sonora ideais para os blocos da metade do vídeo.",
                },
              ]}
