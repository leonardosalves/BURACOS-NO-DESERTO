...
export class TabErrorBoundary extends React.Component<Props, State> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div className="flex flex-col items-center justify-center min-h-[40vh] gap-3 p-8 text-center font-sans">
          <p className="text-sm font-bold text-red-300">Erro ao abrir {this.props.label}</p>
