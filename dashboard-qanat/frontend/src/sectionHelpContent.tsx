...
export const SECTION_HELP: Record<string, SectionHelpEntry> = {
  ...
  'tab-scene-timing': {
    ...
    body: (
      <>
        Ajuste a duração de cada cena <strong>dentro do bloco</strong>. A narração exibida vem do áudio Whisper — ao mudar a duração, as palavras redistribuem na janela.
        Use <strong>Sincronizar bloco com a voz</strong> para alinhar ao texto do storyboard e <strong>Salvar timing</strong> antes do render.
      </>
    ),
  },
  'timeline-opencut': {
  ...
  'video-resurrector': {
    ...
    body: (
      <>
        ...
        Com o dashboard aberto, os horários 11h e 18h disparam sozinhos. Após gerar metadados, o sistema <strong>publica automaticamente no YouTube</strong> (desative em Configuração se quiser revisar antes). Upload da capa continua manual em vídeos longos.
      </>
    ),
  },
  'tab-home': {
