...
export function OverlaySvgIcon({ id, size = 20, color = '#D4AF37' }: { id: string; size?: number; color?: string }) {
...
function SparklesIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="2" className="overlay-svg-spin-slow">
...
function FlameIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="1.5" className="overlay-svg-flicker">
...
function EarthIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="1.5" className="overlay-svg-spin-slow">
...
function GearIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="1.5" className="overlay-svg-spin">
...
function ShieldIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="2" className="overlay-svg-pulse">
...
function CrownIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill={`${color}44`} stroke={color} strokeWidth="1.5" className="overlay-svg-pulse">
...
function AtomIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="1.2" className="overlay-svg-orbit">
...
function HourglassIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="2" className="overlay-svg-flip">
...
function LeafIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="2" className="overlay-svg-sway">
      <path d="M2 22C6 18 8 16 11 2c4 0 8 4 8 9s-4 9-10 11" />
    </svg>
  );
}

function CoinIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill={`${color}22`} stroke={color} strokeWidth="2" className="overlay-svg-flip-y">
      <circle cx="12" cy="12" r="10" />
...
function AlertIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill={`${color}22`} stroke={color} strokeWidth="2" className="overlay-svg-blink">
...
function CompassIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="2" className="overlay-svg-wiggle">
      <circle cx="12" cy="12" r="10" />
...
function HeartIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill={`${color}44`} stroke={color} strokeWidth="2" className="overlay-svg-pulse">
      <path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z" />
    </svg>
  );
}

function BulbIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="2" className="overlay-svg-glow">
      <path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7V17h8v-2.3A7 7 0 0 0 12 2z" fill={`${color}22`} />
    </svg>
  );
}

function SwordsIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="2" className="overlay-svg-cross">
...
function StarIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill={`${color}55`} stroke={color} strokeWidth="1.5" className="overlay-svg-pulse">
...
function BoltIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill={color} stroke={color} strokeWidth="1" className="overlay-svg-blink">
      <path d="M13 2L3 14h7l-1 8 10-12h-7l1-8z" />
    </svg>
  );
}

function RocketIcon({ size, color }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth="1.5" className="overlay-svg-float">
