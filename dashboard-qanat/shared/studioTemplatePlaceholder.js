const TEMPLATE_PLACEHOLDER_TEXT_RE =
  /^(COMPARA[ÇC][AÃ]O|TESTE|DADO|IMPACTO|REVELA[ÇC][AÃ]O|CRONOLOGIA|T[IÍ]TULO|SUBT[IÍ]TULO|OVERVIEW|VIS[AÃ]O\s*GERAL|RESUMO\s*T[EÉ]CNICO|CONTE[ÚU]DO\s*PRINCIPAL|ANO\s*DA\s*MISS[AÃ]O|MATERIAL\s*COMPOSI[ÇC][AÃ]O|PONTO\s*DE\s*REFER[EÊ]NCIA|JANELA\s*PIP|PIP\s*LOCALIZA[ÇC][AÃ]O|MAPA\s*[·•]\s*ROTA|LOCAL|LOREM|PLACEHOLDER|EXEMPLO|SAMPLE|HEADLINE|SUBHEAD|DESCRIPTOR)$/i;
