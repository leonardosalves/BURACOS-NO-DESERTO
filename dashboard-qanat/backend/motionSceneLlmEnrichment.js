...
export function buildMotionSceneEnrichmentPrompt({
  ...
  return [
    ...
    "- ESCOLHA DE TEMPLATE: location-intro = descida satélite/Blender (PIP, 8s+); geo-map = pin regional rápido (sem flyover); counter/bar-chart/timeline = dados da narração.",
