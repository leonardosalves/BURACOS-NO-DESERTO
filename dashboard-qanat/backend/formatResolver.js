...
export const FORMAT_SUCCESS_RULES = {
  SHORT: [
    ...
    { category: "listicle", description: "Listicle Short: máx. 2 overlays IA + HUD rank-progress; sem lower-third/kinetic/bar-chart" },
  ],
  LONG: [
    { category: "hook", description: "Gancho limpo até 5s antes do primeiro overlay informativo" },
    { category: "overlay_timing", description: "Gap mínimo 18s entre overlays informativos (12s em listicle longo)" },
