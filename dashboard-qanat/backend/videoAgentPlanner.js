...
export const LUMIERA_AGENT_REGISTRY = {
  ...
  deep_research: {
    node: "DeepResearch",
    label: "Pesquisa profunda (DeerFlow)",
    tab: "youtube-studio",
    description: "Web + Exa + concorrentes + NotebookLM → relatório Obsidian.",
    inputs: ["topic", "niche"],
    outputs: ["research_report", "derived_ideas"],
  },
  agent_reach: {
    node: "AgentReach",
    label: "Busca na internet (Agent Reach)",
    tab: "agent-reach",
    description: "Exa, Jina, GitHub, Bilibili e RSS — sem terminal.",
    inputs: ["topic", "niche"],
    outputs: ["web_sources", "research_summary"],
  },
  competitor_research: {
