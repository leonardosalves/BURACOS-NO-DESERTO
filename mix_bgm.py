...
def main():
    ...
    if max_val > 0:
        bgm_audio = (bgm_audio / max_val) * 0.89
        
    # Convert back to 16-bit integer PCM and save as MP3
    output_audio_int16 = (bgm_audio * 32767).astype(np.int16)
